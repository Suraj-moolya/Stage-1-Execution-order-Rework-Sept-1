...
Scenario Outline: Creating Multiple instances with specific template in Application Explorer
  ...
  Examples:
    ...
    | 1    | MotorGP           | MotorGP_1$$1.0.123$$Folder_1 | 5000  |
    
  @Create_DigitalInput_10
  Examples:
    | TemplatesBrowser1 | TemplatesBrowser2                | Count |
    | DigitalInputGP    | DigitalInputGP$$1.0.81$$Folder_1 | 10    |
    
  @Create_Digitaloutput_10
  Examples:
    | TemplatesBrowser1 | TemplatesBrowser2                 | Count |
    | DigitaloutputGP   | DigitalOutputGP$$1.0.76$$Folder_1 | 10    |
    
  @Create_AnalogInputGP_10
  Examples:
    | TemplatesBrowser1 | TemplatesBrowser2                | Count |
    | AnalogInputGP     | AnalogInputGP$$1.0.138$$Folder_1 | 10    |
    
  @Create_Analogoutput_10
  Examples:
    | TemplatesBrowser1 | TemplatesBrowser2                | Count |
    | AnalogoutputGP    | AnalogOutputGP$$1.0.93$$Folder_1 | 10    |
